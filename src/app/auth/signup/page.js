    ...
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      >
        <Card className="border border-white/20 shadow-2xl backdrop-blur-md bg-white/10">
          <CardHeader className="bg-gradient-to-br from-blue-400/90 to-green-500/90 text-white rounded-t-lg space-y-1 backdrop-blur-sm">
            <div className="flex items-center space-x-2">
              <UserPlus className="w-6 h-6" />
              <CardTitle className="text-2xl">Create Account</CardTitle>
            </div>
            <CardDescription className="text-white/90">
              Join us to get started with your agricultural journey
            </CardDescription>
          </CardHeader>
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex flex-col space-y-4">
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500/90 to-green-500/90 hover:from-blue-600/90 hover:to-green-600/90 text-white backdrop-blur-sm"
                disabled={loading}
              >
                {loading ? (
